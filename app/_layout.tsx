...
import { singularTrackAppOpen } from "@/lib/singular";
...
export default function RootLayout() {
  ...
  useEffect(() => {
    initManusRuntime();
    // Fire custom app_open event on every app launch (Firebase also fires automatically,
    // but this explicit call confirms SDK init and is visible in DebugView)
    trackAppOpen();
    // Mirror to Singular (Singular.init is called from subscription-provider after RC user ID is known)
      ...
      <trpc.Provider client={trpcClient} queryClient={queryClient}>
        <QueryClientProvider client={queryClient}>
          ...
          <Stack screenOptions={{ headerShown: false }}>
            ...
            <Stack.Screen name="save-meal-template" />
